...
public class UotelDriver {
	...
	public static void thSelected(TH th, Connector con, BufferedReader in, User usr) throws IOException {
		...
		while (true) {
			...
			/*
			 * System.out.println("1. Mark as favorite"); System.out.println(
			 * "2. View feedback"); System.out.println("3. Give feedback");
			 * System.out.println("4. Make a reservation"); System.out.println(
			 * "5. Record a Stay"); System.out.println(
			 * "6. Get most useful feedback");
			 */
		}
	}
